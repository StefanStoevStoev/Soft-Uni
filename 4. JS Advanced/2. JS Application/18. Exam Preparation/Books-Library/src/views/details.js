import { deleteBook, getBookById, getLikesByBookId, getMyLikeByBookId } from '../api/data.js';
import { html } from '../lib.js';
import { getUserData } from '../util.js';

const detailsTemplate = (book, isOwner, onDelete, likes, showLikeBtn) => html `
...
export async function detailsPage(ctx) {
    ...
    ctx.render(detailsTemplate(book, isOwner, onDelete, likes, showLikeBtn));
