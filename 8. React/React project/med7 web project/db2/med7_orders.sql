...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `fk_users_id` FOREIGN KEY (`fk_users_id`) REFERENCES `users` (`id`)
...
INSERT INTO `orders` VALUES (33,2,1,1,0,'2023-10-09 02:35:20',NULL),(33,1,1,0,0,NULL,NULL),(33,2,1,0,0,NULL,NULL),(33,3,1,0,0,NULL,NULL);
